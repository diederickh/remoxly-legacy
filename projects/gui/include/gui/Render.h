...
namespace rx { 
  ...
  public:
	...
	virtual void addLineStrip( int size, float* points, float* color );
    ...
    virtual void addRoundedShadowLine(float x, float y, float w, float h, float radius, float* color, int corners);
